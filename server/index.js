...
mongoose
  .connect(
    'mongodb+srv://mohamed:300793@cluster0-hdbga.mongodb.net/test?retryWrites=true&w=majority',
...
setTimeout(() => {
  ...
  app.get('/api/categorie', productsController.readFromCategorie);
  ...
  //When a admin deletes a user, need an id to specify a product to delete.
